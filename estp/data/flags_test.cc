...
using Flags8 = Flags<uint8_t, Letters>;
using Flags16 = Flags<uint16_t, Letters>;

TEST_CASE("Flags: Construction") {
    SECTION("Empty set") {
        auto f8 = Flags8{};
        REQUIRE(0 == f8.bits());
